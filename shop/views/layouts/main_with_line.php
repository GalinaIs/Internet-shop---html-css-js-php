...
<body>
    ...
    <nav>
        <div class="container">
            <ul class="menu">
                <li>
                    <a href="/product/index" class="ref_page1">Home</a>
                </li>
                <li>
                    <div id="ref_man_page">
    ...
    <nav class="nav_products">
        <div class="container">
            <div class="products_menu">
                <div class="flex_member_produts_menu label_produts_menu">New Arrivals</div>
                <div class="flex_member_produts_menu">
                    <ul class="products_menu_crumb">
                        <li>
                            <a href="/product">Home</a>
                        </li>
                        <li>
                            <a href="/product/man">Men</a>
                        </li>
                        <li>New Arrivals</li>
                    </ul>
                </div>
